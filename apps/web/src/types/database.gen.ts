 ...
 *
 * Перезаписывается джобом «Типы из схемы» в CI после каждой миграции:
 *   supabase gen types --lang typescript --local > database.gen.ts
 *
 * Псевдонимы и хелперы живут в соседнем database.ts — он переживает регенерацию.
 */
